...
if(isset($_GET["dec"])){
    ...
    if($dec==1){
        ...
        for($i=count($test)-1;$i>=0;$i--){
            ...
            ECHO '<a style="color: white; text-decoration: none;" href="../action/takePart.php?id='.$test[$i]['id'].'">'.'<p style="text-align: center; color: white; background-color: orange; margin: 0 0 0 0; padding: 0 0 0 0;"><b>'.'Wez udzial +'.'</b></p></a>';
