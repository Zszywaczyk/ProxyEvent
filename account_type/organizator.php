...
<a class="aaa" href="../form/form_createProject.php">
        <img id="orgaction1" src="../img/dprojekt.png" alt="dodaj projekt" >
    <span id="texttip1">Nowy projekt</span>

</a>
<a class="bbb" href="">
        <img id="orgaction2" src="../img/dwolontariusza.png" alt="dodaj wolontariusza" >
    <span id="texttip2">Znajdz wolontariuszy</span>
</a>
    <div id="pnav">
